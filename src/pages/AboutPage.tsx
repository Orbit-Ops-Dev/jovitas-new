        ...
        <Container>
          ...
          <ContentSection>
            <TextContent>
              ...
              <Text>
                Liria's Cleaning Service has been serving Suffolk County with dedication and professionalism.
                We understand that your home or business is important to you, and we treat every space with
                the care and attention it deserves.
              </Text>
              <Text>
                Our commitment to excellence and customer satisfaction has made us a trusted name in
                residential and commercial cleaning throughout the Bellport, NY area.
              </Text>
            </TextContent>
          </ContentSection>
              ...
              <FeaturesList>
                ...
                <FeatureItem>
                  ...
                  <FeatureContent>
                    ...
                    <FeatureText>
                      We're not satisfied until you are. We stand behind our work 100%.
                    </FeatureText>
                  </FeatureContent>
                </FeatureItem>
          ...
          <ContentSection>
            <TextContent>
              ...
              <Text>
                We are committed to providing top-quality cleaning services that exceed your expectations.
                Whether you need a one-time deep clean or regular maintenance, we bring professionalism,
                attention to detail, and a personal touch to every job.
              </Text>
            </TextContent>
          </ContentSection>
        </Container>
